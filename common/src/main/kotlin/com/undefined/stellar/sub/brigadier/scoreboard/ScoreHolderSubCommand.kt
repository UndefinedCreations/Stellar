...
class ScoreHoldersSubCommand(parent: AbstractStellarCommand<*>, name: String) : BaseStellarSubCommand<ScoreHoldersSubCommand>(parent, name) {
...
class ScoreHolderSubCommand(parent: AbstractStellarCommand<*>, name: String) : BaseStellarSubCommand<ScoreHolderSubCommand>(parent, name) {
