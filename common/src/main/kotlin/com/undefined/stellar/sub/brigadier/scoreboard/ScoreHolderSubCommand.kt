...
class ScoreHoldersSubCommand(parent: BaseStellarCommand<*>, name: String) : BrigadierTypeSubCommand<ScoreHoldersSubCommand>(parent, name) {
...
class ScoreHolderSubCommand(parent: BaseStellarCommand<*>, name: String) : BrigadierTypeSubCommand<ScoreHolderSubCommand>(parent, name) {
