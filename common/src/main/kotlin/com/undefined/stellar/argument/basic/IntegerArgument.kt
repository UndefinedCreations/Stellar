 ...
 * @since 1.13
 */
class IntegerArgument(name: String, minimum: Int = Int.MIN_VALUE, maximum: Int = Int.MAX_VALUE) : ParameterArgument<IntegerArgument, Int>(name, IntegerArgumentType.integer(minimum, maximum))