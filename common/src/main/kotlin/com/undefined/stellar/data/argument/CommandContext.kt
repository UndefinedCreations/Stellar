 ...
 *
 * @param arguments A [HashMap] of arguments of with the key being the argument name, and the value being its return value.
...
class CommandContext<T : CommandSender>(val arguments: CommandNode, val sender: T, val input: String) {
     ...
     */
    operator fun get(name: String): Any? = (arguments[name]
     ...
     * @return The argument as an [Object] or a [Any] (in Kotlin), which returns null if the argument cannot be cast successfully.
     */
    operator fun get(index: Int): Any? = arguments.values.toList()[index](this as CommandContext<CommandSender>)
