...
object NMS1_14_4 : NMS {
    ...
    private fun getParticleData(particle: Particle, options: ParticleParam): ParticleData<*> = when (options) {
        ...
        is ParticleParamItem -> ParticleData(
            particle,
            CraftItemStack.asBukkitCopy(options::class.java.getDeclaredMethod("c").also { it.isAccessible = true }(null) as net.minecraft.server.v1_14_R1.ItemStack)
        )
