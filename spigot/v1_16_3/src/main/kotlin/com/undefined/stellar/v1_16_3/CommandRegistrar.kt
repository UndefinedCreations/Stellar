...
import com.undefined.stellar.v1_16_3.BrigadierCommandHelper
...
object CommandRegistrar : AbstractCommandRegistrar {
    ...
    val dispatcher: CommandDispatcher<CommandListenerWrapper> by lazy { MinecraftServer.getServer().functionData.commandDispatcher }
