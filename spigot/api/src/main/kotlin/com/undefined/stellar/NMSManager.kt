...
object NMSManager: AbstractNMSManager() {
    ...
    private val versions: Map<String, () -> NMS> = mapOf(
        "1.21.10" to { NMS1_21_10 },
        "1.21.9" to { NMS1_21_10 },
        "1.21.8" to { NMS1_21_8 },
        "1.21.7" to { NMS1_21_8 },
        "1.21.6" to { NMS1_21_8 },
        "1.21.5" to { NMS1_21_5 },
    ...
    private fun handleCommandFunctions(command: AbstractStellarCommand<*>, builder: ArgumentBuilder<Any, *>) {
        handleExecutions(command, builder)
        handleSuggestions(command, builder)
        handleRequirements(command, builder)
    }

    private fun handleExecutions(command: AbstractStellarCommand<*>, builder: ArgumentBuilder<Any, *>) {
        ...
        builder.executes { context ->
            ...
            handleExecutions(command, stellarContext, context, subArguments)
        }
    }
