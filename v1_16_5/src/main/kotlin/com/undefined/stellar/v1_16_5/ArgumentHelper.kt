...
object ArgumentHelper {
    ...
    private fun <T : AbstractStellarArgument<*>> getArgumentType(argument: T): ArgumentType<*> =
        when (argument) {
            ...
            is com.undefined.stellar.argument.types.math.AngleArgument -> ArgumentAngle.a()
    ...
    fun <T : AbstractStellarArgument<*>> getParsedArgument(context: CommandContext<CommandListenerWrapper>, argument: T): Any? {
        return when (argument) {
            ...
            is com.undefined.stellar.argument.types.text.ColorArgument -> ArgumentChatFormat.a(
                context,
                argument.name
            ).e()?.let { Style.style(TextColor.color(it)) } ?: Style.empty()
            ...
            is com.undefined.stellar.argument.types.math.AngleArgument -> ArgumentAngle.a(context, argument.name)
            ...
            is com.undefined.stellar.argument.types.world.DimensionArgument -> ArgumentDimension.a(context, argument.name).world.environment
            is GameModeArgument -> throwArgumentVersionException(argument)
            ...
            is AttributeArgument -> Registry.ATTRIBUTE.get(getId(context, argument.name))
